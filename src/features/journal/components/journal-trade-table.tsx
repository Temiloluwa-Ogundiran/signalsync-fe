                ...
                {hg.headers.map((header) => {
                  ...
                  return (
                    <th
                      ...
                      className={cn(
                        "sticky top-0 z-10 whitespace-nowrap border-b border-hairline bg-nav-sidebar-bg px-3 py-2.5 text-left text-[11px] font-semibold uppercase text-text-tertiary",
