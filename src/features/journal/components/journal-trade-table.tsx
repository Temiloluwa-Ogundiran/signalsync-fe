                ...
                {hg.headers.map((header) => {
                  ...
                  return (
                    <th
                      ...
                      className={cn(
                        "sticky top-0 z-10 whitespace-nowrap border-b border-hairline bg-nav-sidebar-bg px-3 py-2.5 text-left text-[11px] font-semibold uppercaser text-text-tertiary",
...
function SummaryStat({
  ...
  return (
    <span className="flex items-baseline gap-1.5">
      <span className="text-[11px] font-medium uppercaser text-text-tertiary">
        {label}
      </span>
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-2 sm:grid-cols-4">
        {facts.map((f) => (
          <div key={f.label} className="flex flex-col gap-0.5">
            <span className="text-[11px] uppercaser text-text-tertiary">
              {f.label}
            </span>
