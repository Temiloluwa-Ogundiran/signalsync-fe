  ...
  return (
    <div className="group/btn relative">
      <button
        ...
        aria-label={label}
        className={cn(
          "rounded-md p-1.5 text-text-secondary transition-colors hover:bg-bg-tertiary hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50",
          className,
        )}
      >
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-1/2 z-tooltip mb-2 -translate-x-1/2 whitespace-nowrap rounded-md border border-border-secondary bg-card-bg px-2 py-1 text-xs font-medium text-text-primary opacity-0 shadow-lg transition-opacity duration-100 group-hover/btn:opacity-100 group-focus-within/btn:opacity-100"
      >
        {label}
      </span>
    </div>
            ...
            {accounts.map((account) => {
              ...
              return (
                <Card
                  key={account.id}
                  className={cn(
                    "group relative z-0 flex flex-col gap-0 rounded-lg border border-border-secondary/70 bg-card-bg shadow-sm transition-[border-color,box-shadow,opacity] duration-200 hover:z-10 hover:border-border-secondary hover:shadow-md",
                ...
                >
                  <CardContent className="flex flex-1 flex-col gap-5 p-5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="break-words text-xs font-medium text-text-secondary">
                    ...
                    <div className="mt-auto border-t border-border-secondary/50 pt-3">
                      ...
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <div className="min-w-0">
                          ...
                          {syncStatusDetail ? (
                            <p className="line-clamp-2 text-[11px] font-medium text-text-secondary">
                              {syncStatusDetail}
                            </p>
                          ) : null}
                        </div>
                      ...
                      {!isArchived ? (
                        <Link href={`/trade-history?accountId=${account.id}`} className="mt-3 inline-flex w-full items-center justify-center rounded-md border border-border-secondary px-3 py-2 text-xs font-semibold text-text-primary transition-colors hover:bg-bg-tertiary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent">
                          View trades
                        </Link>
                      ) : null}
                    </div>
